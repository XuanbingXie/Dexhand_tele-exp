...
def main():
    ...
    # init point
    # point = [0.5177497966915591, -0.12940691182751748, -0.152, -2.8899641036987305, -1.0299427509307861, 0.4399895668029785]
    # point = [0.55,-0.067,0.125,3.073,-1.138,0.768]
    # point = [0.474991,-0.14171,-0.032832,-3.087,-0.833,0.674]
    point = [0.5105784932154902, -0.04870183948428121, -0.15, -3.048161268234253, -1.154045581817627, 0.639144778251648]

    robot_controller.movel(point, v = 10)
